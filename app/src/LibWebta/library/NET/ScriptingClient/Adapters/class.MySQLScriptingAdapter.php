<?php    
	 ...
	 *
	 */
	class MySQLScriptingAdapter extends AbstractScriptingAdapter implements ScriptingAdapter
	{
	    ...
	    */
		...
		{  
		    ...
		    $this->DB = Core::GetDBInstance($connection_info, true, 'mysql');
		    if (!$this->DB)   	     
                return false;
