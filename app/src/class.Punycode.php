...
class Punycode
{
	 ...
	 */
	public static function Encode ($utf8_string)
	{
		self::InitIDNAConverter();
		return self::$IDNAConverter->encode($utf8_string);
	}
	
	/**
	 * Decode a given punycode domain name.
	 */ 
	public static function Decode ($punycode_string)
	{
		self::InitIDNAConverter();
		return self::$IDNAConverter->decode($punycode_string);
	}
}
// {{{ license
