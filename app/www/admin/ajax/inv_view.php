<?php
	...
	// Start compiling SQL query. YARR! ME BEST IN COMPILING SQL QUERIEZ!	
	$sql = "SELECT * from invoices WHERE id!='' AND hidden=0";
	...
	foreach ($db->GetAll($sql) as $row)
	{
		...
		$userinfo = $db->GetRow("SELECT * FROM users WHERE id='{$row['userid']}'");		
