{include file="client/inc/header.tpl" upload_files=true}
	{include file="client/inc/table_header.tpl"}
		{include file="client/inc/intable_header.tpl" header="API settings" color="Gray"}
		<tr>
		...
		{include file="client/inc/intable_header.tpl" header="Allowed IP list" color="Gray"}
